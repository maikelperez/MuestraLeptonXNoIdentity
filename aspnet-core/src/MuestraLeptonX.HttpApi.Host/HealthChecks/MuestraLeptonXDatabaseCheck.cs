...
public class MuestraLeptonXDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MuestraLeptonXDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
